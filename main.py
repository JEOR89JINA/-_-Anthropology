...
def get_groq_response(prompt, context_type="comment"):
    system_instruction = (
        ...
        "ردودك يجب أن تكون عميقة، ذو طابع إسلامي بحت علمية، ومبسطة في نفس الوقت، وتطرح تحليلات أنثروبولوجية ممتعة بناءً على النص المعطى."
    )
    
    if context_type == "channel_post":
        user_message = f"اكتب توضيحاً وتحليلاً أنثروبولوجياً عميقاً ومثيراً للاهتمام حول هذا المنشور ،بالطريقة الإسلامية: {prompt}"
    else:
